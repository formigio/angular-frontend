...
apigClientFactory.newClient = function (config) {
    ...
    apigClient.authGet = function (params, body, additionalParams) {
        ...
        apiGateway.core.utils.assertParametersDefined(params, ['Content-Type', 'Accept', 'x-amz-security-token', 'x-forward-Authorization', 'x-forward-amz-date'], ['body']);
        
        var authGetRequest = {
            verb: 'get'.toUpperCase(),
            path: pathComponent + uritemplate('/auth').expand(apiGateway.core.utils.parseParametersToObject(params, [])),
            headers: apiGateway.core.utils.parseParametersToObject(params, ['Content-Type', 'Accept', 'x-amz-security-token', 'x-forward-Authorization', 'x-forward-amz-date']),
            queryParams: apiGateway.core.utils.parseParametersToObject(params, []),
            body: body
        };
